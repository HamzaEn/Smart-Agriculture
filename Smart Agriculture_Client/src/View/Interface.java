...
public class Interface extends JFrame{
	...
	public void initialiser_Espace() throws IOException {
		...
		bvoirdecision =new JButton("voir les résultat des capteur");
		...
		bvoirdecision= new JButton("voir les résultat des capteur");
		 ...
		 Espace_Panel.add(phaut,BorderLayout.PAGE_START);
		   ...
		   BufferedImage img = ImageIO.read(new File("C:\\Users\\HP\\Desktop\\bbbb\\Smart Agriculture_Client\\src\\View\\clientespace.png"));
